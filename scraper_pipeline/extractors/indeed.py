...
def extract_indeed_jobs(keyword: str, location: str) -> list:
    """
    Indeed blocks datacenter IPs actively. 
    ...
    try:
        ...
        for item in channel.findall('item'):
            ...
            extracted_jobs.append({
                ...
                "source_platform": "Indeed (via Jooble)"
            })
    except Exception as e:
        print(f"Indeed/Jooble extraction error via RSS: {e}")
